 ...
 **************************************************************************/
    ...
    #define TASK_4_STACK_SIZE 200/4 // size = 200 bytes
...
#define MAX_PRIORITY 0x80U
    ...
    EE_TYPEPRIO EE_rq_link[EE_MAX_TASK] =
        { 
        #include "OS_task_priorities.inc"
            #if EE_MAX_TASK > 0
            TSK1_PRI
            #endif
            #if EE_MAX_TASK > 1
 ...
 **************************************************************************/
    ...
    */
    EE_TYPEBOOL EE_resource_locked[EE_MAX_RESOURCE] =
        ...
        #include "OS_resource_priorities.inc"
 ...
 **************************************************************************/
    ...
    const EE_oo_counter_object_ROM_type   EE_oo_counter_object_ROM[EE_COUNTER_OBJECTS_ROM_SIZE] = {
        #if EE_MAX_ALARM > 0
        {0, alrm_100ms, EE_ALARM }
        #endif
        #if EE_MAX_ALARM > 1
        ,{0, alrm_500ms, EE_ALARM }
        #endif
        #if EE_MAX_ALARM > 2
        ,{0, Alarm_3, EE_ALARM }
        #endif
