...
#include "OS_eecfg.inc"

#include "OS_ee_rtdruid_versions.inc"
...
#ifdef __CORTEX_MX__
#include "OS_cortex_mx_ee_cpu.inc"
#endif
...
#include "OS_ee_oo_kernel.inc"
#include "OS_ee_as_kernel.inc"
/* Moved inline interrupt services inclusion here, because they need to see TP
   declarations */
#include "OS_ee_oo_inline.inc"
#ifdef EE_AS_IOC__
#include "OS_ee_as_ioc.inc"
/*                                 WARNING
   ...
   project root. */
#include "OS_ioc_common.inc"
#endif /* EE_AS_IOC__ */

#ifdef EE_AS_SCHEDULETABLES__
#include "OS_ee_as_schedule_tables.inc"
...
/* SEM */
#ifdef __SEM__
#include "OS_ee_sem.inc"
#endif

/* ALARMS */
#ifdef __ALARMS__
#include "OS_ee_alarms.inc"
#endif

/* RN */
#if (defined(__RN__)) || (defined(EE_AS_RPC__))
#include "OS_ee_rn.inc"
