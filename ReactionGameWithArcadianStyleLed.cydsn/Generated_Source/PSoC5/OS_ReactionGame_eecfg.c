 ...
 **************************************************************************/
    ...
    int EE_cortex_mx_stack_2[TASK_2_STACK_SIZE];	/* Task 2 (tsk_ledFader) */
    #endif
    ...
    struct EE_TOS EE_cortex_mx_system_tos[EE_CORTEX_MX_SYSTEM_TOS_SIZE] = {
        ...
        #endif
        #ifdef TASK_2_STACK_SIZE
        ,{(EE_ADDR)(&EE_cortex_mx_stack_2[(TASK_2_STACK_SIZE) - CORTEX_MX_INIT_TOS_OFFSET])}	/* tsk_ledFader*/
        #endif
        #ifdef TASK_3_STACK_SIZE
 ...
 **************************************************************************/
    ...
    #endif
    #if EE_MAX_TASK > 1
        ,&EE_oo_thread_stub      /* thread tsk_ledFader */
    #endif
    #if EE_MAX_TASK > 2
...
#define MAX_PRIORITY 0x80U
    ...
    EE_TYPEPRIO EE_rq_link[EE_MAX_TASK] =
        { 
        #include "OS_ReactionGame_task_priorities.inc"
            #if EE_MAX_TASK > 0
            TSK1_PRI
            #endif
            #if EE_MAX_TASK > 1
 ...
 **************************************************************************/
    ...
    */
    EE_TYPEBOOL EE_resource_locked[EE_MAX_RESOURCE] =
        ...
        #include "OS_ReactionGame_resource_priorities.inc"
