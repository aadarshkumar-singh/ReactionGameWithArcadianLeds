...
//####################### Enumerations
/**
* \brief Enumeration identifying the button being pressed
*
*/
enum eButton{
    BUTTON_1,          /**< Upper left */
    BUTTON_2,          /**< Upper right */
    BUTTON_3,          /**< Lower left */
    BUTTON_4,          /**< Lower right */
} ;  
typedef enum eButton BUTTON_id_t;
...
/**
 * Initialize Button
 * @param cyisraddress address - the address of the ISR to be called
